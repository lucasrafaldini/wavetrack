...
- **Estatísticas Visíveis**:
  ...
  - ⏱️ Threshold offline (20 minutos)
...
├──────┼─────┼───────┼─────────────┼────────┼──────┼─────────┤
│João  │00:11│  TI   │iPhone 15 Pro│ Apple  │28/10 │ ✏️  🗑️  │
│Maria │AA:BB│  RH   │Galaxy S23   │Samsung │27/10 │ ✏️  🗑️  │
└──────┴─────┴───────┴─────────────┴────────┴──────┴─────────┘
```
...
3. Clica em ✏️ ao lado de "João Silva"
...
2. Gerente vai em "Colaboradores"
3. Clica em 🗑️ ao lado de "Maria Santos"
...
**Desenvolvido com ❤️ para WaveTrack**
